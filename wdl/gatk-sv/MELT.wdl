...
workflow MELT {
  ...
  if (!have_multiple_metrics) {
    call GetMultipleMetrics {
      input:
        ...
        machine_type = metrics_machine_type
    }
  ...
  if (!have_wgs_metrics) {
    call GetWgsMetrics {
      input:
        ...
        machine_type = coverage_machine_type
    }
  ...
  call RunMELT {
    input:
      ...
      machine_type = melt_machine_type
  }
